...
exports.initPublishedRoomCode = initPublishedRoomCode;
...
function initPublishedRoomCode() {
    customElements.define('x-code-published', class RoomCodePublished extends HTMLElement {
        shadow = this.attachShadow({ mode: 'open' });
        me = state_1.state.data.name;
        anotherPlayer = 'other';
        codeRoom;
        constructor() {
            super();
        ...
        render() {
            this.codeRoom = state_1.state.data.keyRoom == 0 ? 123456 : state_1.state.data.keyRoom;
