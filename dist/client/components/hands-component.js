...
exports.handsComponent = handsComponent;
const images = [
    {
        option: 'piedra',
...
function handsComponent() {
    customElements.define('x-hand-option', class HandOption extends HTMLElement {
        ...
        render() {
            ...
            const option = images.find((item) => item.option === this.getAttribute('hand'));
