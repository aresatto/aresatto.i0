...
exports.initEntranceRoom = initEntranceRoom;
const state_1 = require("../state");
function initEntranceRoom() {
    customElements.define('x-exist-room', class ExistingRoom extends HTMLElement {
        ...
        listener() {
            ...
            formEl.addEventListener('submit', (e) => {
                ...
                state_1.state.createUser(nameUser, roomCode);
