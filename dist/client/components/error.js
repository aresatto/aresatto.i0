...
exports.initErrorPage = initErrorPage;
...
function initErrorPage() {
    customElements.define('x-error', class Error extends HTMLElement {
        ...
        render() {
            const errorText = ERROR.find((e) => e.error == state_1.state.data.error);
