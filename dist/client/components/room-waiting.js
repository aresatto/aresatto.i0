...
exports.initRoomWaiting = initRoomWaiting;
...
function initRoomWaiting() {
    customElements.define('x-room-waiting', class RoomWinting extends HTMLElement {
        shadow = this.attachShadow({ mode: 'open' });
        me = state_1.state.data.namePlayers.me;
        anotherPlayer = state_1.state.data.namePlayers.other;
        codeRoom = 12345;
        constructor() {
            super();
            this.render();
        ...
        render() {
            ...
            this.codeRoom = state_1.state.data.keyRoom;
            this.shadow.innerHTML = `
            <main class='container'>
                <header class='header'>
                    <aside class='header__players-score'>
                        <h2 class='header__players-score__me'>${this.me}: ${state_1.state.data.points.me}</h2>
                        <h2 class='header__players-score__another'>${this.anotherPlayer}: ${state_1.state.data.points.other}</h2>
                    </aside>
